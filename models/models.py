...
class User(TimestampMixin, db.Model):
    ...
    address = db.relationship("Address", uselist=False, backref='users', cascade='all, delete')
    ...
    def __repr__(self):
        return "User(user='{}', age={}, address={})".format(self.name, self.age, self.address)
...
class Address(TimestampMixin, db.Model):
    ...
    user_id = db.Column(db.Interger, db.ForeignKey('users.id'), unique=True, nullable=False)
